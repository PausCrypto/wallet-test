...
Forkerd from turtlecoin-wallet-backend
...
`git clone https://github.com/zpalmtree/obscure-wallet-backend.git`

`cd obscure-wallet-backend`
...
```typescript
import { WalletBackend, ConventionalDaemon, BlockchainCacheAPI } from 'obscure-wallet-backend';
